...
var Module = function () {
  ...
  _createClass(Module, [{
    ...
    value: function __subscribe__(modelName) {
      ...
      var token = _observer2.default.subscribe(modelName, function (type, params) {
        return _this.__dispatch__.call(_this, type, params);
      });
    ...
    value: function __unsubscribe__(token) {
      if (token) {
        _observer2.default.unsubscribe(this._tokens);
      } else {
