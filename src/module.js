/*
 * Created Date: Monday July 30th 2018 11:04:57 am
 * Author: chengpu
 * -----
...
export default class Module {
   ...
   */
    __subscribe__(modelName) {      
      // 添加订阅者获得一个订阅号
      const token = ob.subscribe(modelName, (type, params) => this.__dispatch__.call(this, type, params));
      // 记录一下订阅号
